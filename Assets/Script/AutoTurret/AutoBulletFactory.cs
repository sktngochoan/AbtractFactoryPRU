...
public class AutoBulletFactory : BulletFactory
{
    ...
    public override void CreateSlowBullet()
    {
        ...
        if (slowBullet != null)
        {
            var SlowBullet = Instantiate(slowBullet.transform, new Vector2(factoryTransformPosition.x, factoryTransformPosition.y), Quaternion.identity);        }
        else
        {
    ...
    public override void CreateFastBullet()
    {
        ...
        if (fastBullet != null)
        {
            var FastBullet = Instantiate(fastBullet.transform, new Vector2(factoryTransformPosition.x, factoryTransformPosition.y), Quaternion.identity);
        }
        else
        {
